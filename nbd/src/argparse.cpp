...
static int va_argparse_witharg(
        std::vector<const char *> &args,         // NOLINT
        std::vector<const char *>::iterator &i,  // NOLINT
...
template bool argparse_witharg<int>(
        std::vector<const char *> &args,  // NOLINT
        std::vector<const char *>::iterator &i,
        int *ret,                 // NOLINT
        std::ostream &oss, ...);  // NOLINT

template bool argparse_witharg<int64_t>(
        std::vector<const char *> &args,  // NOLINT
        std::vector<const char *>::iterator &i,
        int64_t *ret,             // NOLINT
        std::ostream &oss, ...);  // NOLINT

template bool argparse_witharg<float>(
        std::vector<const char *> &args,  // NOLINT
        std::vector<const char *>::iterator &i,
        float *ret,               // NOLINT
        std::ostream &oss, ...);  // NOLINT
